...
public class TFTPClient extends Thread {
    ...
    private void handleGet(String[] args) {
        ...
        RRQHandler handler = new RRQHandler(remoteAddress, remotePort, remoteFile, localFile);
        handler.run();
    }
    ...
    private void handlePut(String[] args) {
        ...
        WRQHandler handler = new WRQHandler(remoteAddress, remotePort, localFile, remoteFile, Mode.OCTET);
        handler.run();
    }
